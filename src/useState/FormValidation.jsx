...
export const FormValidation = () => {
    ...
    const handelFormDetails = event => {
        ...
        const genderError =
            field === "gender" && value == false && "Gender select required !!";
        const emailError =
            field === "email" &&
            value.length < 3 &&
        ...
        // const lastNameError = lastName.length < 3 && "Last Name must contain at least 3 characters";
    ...
    const submit = event => {
        ...
        const lastNameError =
            lastName.length < 3 && "Second name must contain at least 3 characters";
